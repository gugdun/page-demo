...
export function createTestimonialsAnimation(container: HTMLElement) {
  ...
  const quote1Tl = gsap
    ...
    .fromTo(
      quote1,
      { x: 200, opacity: 0 },
      { x: 200, opacity: 0, scale: 0.5, duration: 1 }
    )
    .to(quote1, { x: 0, opacity: 1, scale: 1, duration: 1 })
    .to(quote1, { x: -200, opacity: 0, scale: 0.5, duration: 1 });
  ...
  const quote2Tl = gsap
    ...
    .fromTo(
      quote2,
      { x: 200, opacity: 0 },
      { x: 200, opacity: 0, scale: 0.5, duration: 2 }
    )
    .to(quote2, { x: 0, opacity: 1, scale: 1, duration: 1 })
    .to(quote2, { x: -200, opacity: 0, scale: 0.5, duration: 1 });
  ...
  const quote3Tl = gsap
    ...
    .fromTo(
      quote3,
      { x: 200, opacity: 0 },
      { x: 200, opacity: 0, scale: 0.5, duration: 3 }
    )
    .to(quote3, { x: 0, opacity: 1, scale: 1, duration: 1 })
    .to(quote3, { y: -200, opacity: 0, duration: 1 });
